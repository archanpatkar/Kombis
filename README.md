...
## Implementation
Combino can be used as a **Embedded DSL** inside of Javascript using **Tagged String Templates**. The DSL completly supports **SKI Combinator Calculus Grammer** which is then **transformed** into ES6(Arrow Functions) this transformation is applied using a **Tag** on **String Template** which will contain the Combino/SKI Code. 
